  ...
  const subjects = [
    {
      title:
        isHome9 || isHome9Dark
          ...
          ? "AI Automation"
          : "Շինարարություն",
      desc: "Հիմնարար կառուցում, վերակառուցում և ընդլայնում՝ ձեր կարիքներին համապատասխան։",
      navButton: true,
    ...
    },
    {
      title:
        isHome9 || isHome9Dark
          ...
          ? "Virtual Reality"
          : "Դիզայն և նախագծում",
      desc: "Ժամանակակից լուծումներ՝ նախագծման և շինարարության համար։",
      navButton: true,
      id: 2,
      path: "#",
      category:
    ...
    },
    {
      ...
      desc: "Որակյալ վերանորոգում՝ նոր տեսք տալու ձեր տարածքին։",
      navButton: true,
      id: 3,
      path: "#",
      category:
    ...
    },
    {
      ...
      desc: "Բարձրակարգ շինանյութեր՝ լավագույն արդյունքի համար։",
      navButton: true,
      id: 4,
      path: "#",
      category:
            ...
            <div className="relative">
              ...
              {isHome9 || isHome9Dark ? (
                ...
                <div>
                  ...
                  Ծառայություններ՝ կառուցված վստահության վրա։
                  </h3>
                  <p className="text-sm md:text-base text-contentColor dark:text-contentColor-dark mb-10px 2xl:mb-50px">
                  Մենք առաջարկում ենք բազմազան ծառայություններ՝ ձեր շինարարական նախագծերը կյանքի կոչելու համար
                  </p>
                  ...
                  Մեր փորձառու մասնագետների թիմը կաջակցի ձեր շինարարական նախագծերին ամեն քայլափոխին՝ վստահություն և գերազանցություն ապահովելով յուրաքանչյուր փուլում։
                  </p>
                  <div>
